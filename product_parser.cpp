...
{
  Product* volume = new Book(categoryID(), prodName_, price_, qty_, author_, isbn_); 
  return volume; 
...
Product* ProductClothingParser::makeProduct()
{
  ...
  Product* attire = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_); 
  return attire; 
...
{
  Product* film = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_); 
  return film; 
